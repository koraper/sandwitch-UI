                    ...
                    sessions: [
                        {
                            ...
                            userDisplays: {
                                missions: [
                                    "원본 데이터 파일(s1_Customer_Survey.xlsx)을 분석하여 개인정보를 제거하시오.",
                                    "데이터 형식을 통일하고 결측값과 이상치를 정제하시오.",
                                    "기초 통계 요약표를 작성하시오."
                                ],
                                submissions: [
                        ...
                        },
                        {
                            ...
                            userDisplays: {
                                missions: [
                                    "전처리된 데이터와 재무 데이터를 분석하여 마케팅팀의 '고객 평점 4.9점' 주장과 재무팀의 '반품 급증, 매출 하락' 데이터 사이의 모순을 규명하시오.",
                                    "데이터 패턴을 발견하고 인구통계적 특성별 만족도 차이를 분석하시오.",
                                    "가설을 설정하고 가설 검증을 위한 추가 분석 방안을 제안하시오."
                                ],
                                submissions: [
                                    "분석 리포트 (800~1000자)"
                                ],
                        ...
                        },
                        {
                            ...
                            userDisplays: {
                                missions: [
                                    "인구통계 편향(Pie Chart)을 시각화하시오.",
                                    "만족도 급락 추세(Line Chart)를 시각화하시오.",
                                    "부정 키워드 분석(Word Cloud)을 시각화하시오."
                                ],
                                submissions: [
                                    "시각화 대시보드 (Pie Chart, Line Chart, Word Cloud 포함)"
                                ],
                        ...
                        },
                        {
                            ...
                            userDisplays: {
                                missions: [
                                    "차트에 나타난 구체적인 수치를 인용하여 위기 상황을 진단(Fact)하시오.",
                                    "데이터에서 발견된 문제의 구체적 원인을 규명(Reason)하시오.",
                                    "위기 탈출을 위한 경영 제언(Proposal)을 작성하시오."
                                ],
                                submissions: [
                                    "위기 대응 경영 제언서 (1000~1500자, 3-Step Logic: Fact-Reason-Proposal)"
                                ],
